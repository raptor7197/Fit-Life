  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-3xl w-full max-w-lg mx-4 max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-primary to-darkText text-white p-6 relative">
          <button
            onClick={onClose}
        ...
        {/* Content */}
        <div className="p-6 h-96 overflow-y-auto relative">
          <AnimatePresence mode="wait">
            {currentStep === 1 && (
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-darkText">Welcome!</h3>
                  <p className="text-primary">Let's start with the basics</p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-accent rounded-xl focus:border-primary focus:outline-none transition-colors duration-200"
            ...
            {currentStep === 2 && (
              ...
              >
                <div className="text-center mb-6">
                  <div className="text-4xl mb-2">🎯</div>
                  <h3 className="text-xl font-bold text-darkText">What's Your Goal?</h3>
                  <p className="text-primary">Choose your primary fitness objective</p>
                </div>
                  ...
                  {goals.map((goal) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-semibold text-darkText">{goal.label}</div>
                          <div className="text-sm text-primary">{goal.description}</div>
                        </div>
                      </div>
                    </button>
                  ))}
            ...
            {currentStep === 3 && (
              ...
              >
                <div className="text-center mb-6">
                  <div className="text-4xl mb-2">📊</div>
                  <h3 className="text-xl font-bold text-darkText">Activity Level</h3>
                  <p className="text-primary">How would you describe your current fitness level?</p>
                </div>
                ...
                <div className="space-y-3">
                  {activityLevels.map((level) => (
                    ...
                    >
                      <div className="font-semibold text-darkText">{level.label}</div>
                      <div className="text-sm text-primary">{level.description}</div>
                    </button>
                  ))}
                </div>
              </motion.div>
            ...
            {currentStep === 4 && (
              ...
              >
                <div className="text-center mb-6">
                  <div className="text-4xl mb-2">📋</div>
                  <h3 className="text-xl font-bold text-darkText">Almost Done!</h3>
                  <p className="text-primary">Just a few more details</p>
                </div>
            ...
            {currentStep === 5 && (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
                className="text-center space-y-6 absolute w-full"
              >
                <div className="text-6xl mb-4">🎉</div>
                <h3 className="text-2xl font-bold text-darkText">Welcome to FitLife!</h3>
            ...
            {currentStep === totalSteps ? (
              <button
                ...
                className={`px-8 py-3 rounded-xl font-semibold transition-all duration-200 ${
                  canProceed()
                    ? 'bg-darkText text-white hover:bg-primary transform hover:scale-105'
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-6 py-3 rounded-xl font-semibold transition-all duration-200 ${
                  canProceed()
                    ? 'bg-primary text-white hover:bg-darkText transform hover:scale-105'
                    : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                }`}
              >
                <span>Next</span>
